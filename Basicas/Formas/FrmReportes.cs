...
namespace HK.Formas
{
    public partial class FrmReportes : Form
    {
        ...
        public void ListadoPlatos(List<Plato> lista)
        {
            ...
            this.reportViewer1.LocalReport.DataSources.Add(new Microsoft.Reporting.WinForms.ReportDataSource("Platos", lista));
            this.reportViewer1.LocalReport.DataSources.Add(new Microsoft.Reporting.WinForms.ReportDataSource("Parametros",new  Parametro[] { Basicas.parametros() } ));

...
-- --------------------------------------------------
-- Date Created: 12/26/2016 15:10:33
-- Generated from EDMX file: C:\HK\Bocaito\Basicas\Model1.edmx
-- --------------------------------------------------
...
GO
IF OBJECT_ID(N'[RestaurantModelStoreContainer].[IngredientesInventariosHistorials]', 'U') IS NOT NULL
    DROP TABLE [RestaurantModelStoreContainer].[IngredientesInventariosHistorials];
GO
